...
- `services.typhon.hashedPasswordFile`: a string containing the path to the hash
  of the admin password in the PHC string format. Use `argon2id` to compute this
  value.
